...
export default function AdminPage() {
  ...
  if (!user || user.email !== "admin@promptops.com") {
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <Card className="bg-slate-800 border-slate-700">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-slate-400 text-sm mt-2">Current user: {user?.email || "Not logged in"}</p>
          </CardContent>
        </Card>
      </div>
    );
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400">PromptOps Management - Welcome {user.username}!</p>
              </div>
            </div>
          </div>
        </div>
          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              ...
              <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
                ...
                <div className="text-slate-400 text-sm mt-1">Last updated: {new Date().toLocaleString()}</div>
              </div>
            </div>
          )}
